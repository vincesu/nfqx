...
(function($, undefined) {
    ...
    $.ui.define('slider', {
        ...
        _create:function() {
            ...
            $("#fla").css({"width": wei, "height": hei});
            $("#img0").css({"width": me.data('wid'), "height": me.data('hei')});
            $("#img1").css({"width": me.data('wid'), "height": me.data('hei')});
            */
        },
...
//            me._initWidHei();
        ...
        _initWidHei:function() {
        	var me = this;
        	var wei = $(window).width();
            var hei = $(window).height();
            $("#"+me.data('mainid')).css({"width": wei, "height": hei});
            $("#img"+me.data('index')).css({"width": me.data('wid'), "height": me.data('hei')});
        },
        
        setMainid:function(mid) {
        	var me = this;
            me.data('mainid',mid);
            me._initWidHei();
        }
